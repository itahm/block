...
public class HRStorageMemory implements Parseable {
	...
	public void parse(long id, String idx, Map<String, Value> oidMap) {
		...
		if (!v.value.equals("1.3.6.1.2.1.25.2.1.2")) {
			return;
		}
		...
		oidMap.put("1.3.6.1.4.1.49447.4.1", new Value(v.timestamp, Long.toString(used * units)));
	}
