...
public class IFInErrors implements Parseable {
	//private final Map<Long, Map<Integer, Long>> error = new HashMap<>();
	...
	public void parse(long id, String idx, Map<String, Value> oidMap) {
		Value v = oidMap.get("1.3.6.1.2.1.2.2.1.14");
		...
		if (l != null) {
			...
			oidMap.put("1.3.6.1.4.1.49447.3.3", new Value(v.timestamp, Long.toString(l)));
		}
